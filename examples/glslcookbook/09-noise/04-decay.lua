...
local TITLE = "Chapter 9 - Decay of a teapot"
local W, H = 800, 600
...
local prog, vsh, fsh = gl.make_program({vertex="shaders/decay.vert", 
                                       fragment="shaders/decay.frag"})
...
local noise_tex = texture.noise_2d(12.0)
gl.active_texture(0)
...
-- set other uniforms
gl.uniformf(loc["LowThreshold"], 0.45)
gl.uniformf(loc["HighThreshold"], 0.65)
