...
local prog1 = make_program("2.2.2.pbr.vert", "2.2.2.pbr.frag") -- pbrShader
local prog2 = make_program("2.2.2.cubemap.vert", "2.2.2.equirectangular_to_cubemap.frag") -- equirectangularToCubemapShader
local prog3 = make_program("2.2.2.background.vert", "2.2.2.background.frag") -- backgroundShader
local prog4 = make_program("2.2.2.cubemap.vert", "2.2.2.irradiance_convolution.frag") -- irradianceShader
local prog5 = make_program("2.2.2.cubemap.vert", "2.2.2.prefilter.frag") -- prefilterShader
local prog6 = make_program("2.2.2.brdf.vert", "2.2.2.brdf.frag") -- brdfShader
make_program = nil

-- get the locations of the uniforms:
local loc1 = {}
local uniforms = { "projection", "view", "model", "camPos",
                  "irradianceMap", "albedoMap", "normalMap", "metallicMap", "roughnessMap", "aoMap",
...
gl.uniformi(loc1.albedoMap, 3)
gl.uniformi(loc1.normalMap, 4)
gl.uniformi(loc1.metallicMap, 5)
gl.uniformi(loc1.roughnessMap, 6)
gl.uniformi(loc1.aoMap, 7)
...
-- rusted iron
local ironAlbedoMap = new_texture("../resources/textures/pbr/rusted_iron/albedo.png")
local ironNormalMap = new_texture("../resources/textures/pbr/rusted_iron/normal.png")
local ironMetallicMap = new_texture("../resources/textures/pbr/rusted_iron/metallic.png")
local ironRoughnessMap = new_texture("../resources/textures/pbr/rusted_iron/roughness.png")
local ironAOMap = new_texture("../resources/textures/pbr/rusted_iron/ao.png")
-- gold
local goldAlbedoMap = new_texture("../resources/textures/pbr/gold/albedo.png")
local goldNormalMap = new_texture("../resources/textures/pbr/gold/normal.png")
local goldMetallicMap = new_texture("../resources/textures/pbr/gold/metallic.png")
local goldRoughnessMap = new_texture("../resources/textures/pbr/gold/roughness.png")
local goldAOMap = new_texture("../resources/textures/pbr/gold/ao.png")
-- grass
local grassAlbedoMap = new_texture("../resources/textures/pbr/grass/albedo.png")
local grassNormalMap = new_texture("../resources/textures/pbr/grass/normal.png")
local grassMetallicMap = new_texture("../resources/textures/pbr/grass/metallic.png")
local grassRoughnessMap = new_texture("../resources/textures/pbr/grass/roughness.png")
local grassAOMap = new_texture("../resources/textures/pbr/grass/ao.png")
-- plastic
local plasticAlbedoMap = new_texture("../resources/textures/pbr/plastic/albedo.png")
local plasticNormalMap = new_texture("../resources/textures/pbr/plastic/normal.png")
local plasticMetallicMap = new_texture("../resources/textures/pbr/plastic/metallic.png")
local plasticRoughnessMap = new_texture("../resources/textures/pbr/plastic/roughness.png")
local plasticAOMap = new_texture("../resources/textures/pbr/plastic/ao.png")
-- wall
local wallAlbedoMap = new_texture("../resources/textures/pbr/wall/albedo.png")
local wallNormalMap = new_texture("../resources/textures/pbr/wall/normal.png")
local wallMetallicMap = new_texture("../resources/textures/pbr/wall/metallic.png")
local wallRoughnessMap = new_texture("../resources/textures/pbr/wall/roughness.png")
local wallAOMap = new_texture("../resources/textures/pbr/wall/ao.png")
...
while not glfw.window_should_close(window) do
   ...
   -- rusted iron
   gl.active_texture(3)
   gl.bind_texture('2d', ironAlbedoMap)
   gl.active_texture(4)
   gl.bind_texture('2d', ironNormalMap)
   gl.active_texture(5)
   gl.bind_texture('2d', ironMetallicMap)
   gl.active_texture(6)
   gl.bind_texture('2d', ironRoughnessMap)
   gl.active_texture(7)
   gl.bind_texture('2d', ironAOMap)
   gl.uniform_matrix4f(loc1.model, true, translate(-5.0, 0.0, 2.0))
   sphere:draw()

   -- gold
   gl.active_texture(3)
   gl.bind_texture('2d', goldAlbedoMap)
   gl.active_texture(4)
   gl.bind_texture('2d', goldNormalMap)
   gl.active_texture(5)
   gl.bind_texture('2d', goldMetallicMap)
   gl.active_texture(6)
   gl.bind_texture('2d', goldRoughnessMap)
   gl.active_texture(7)
   gl.bind_texture('2d', goldAOMap)
   gl.uniform_matrix4f(loc1.model, true, translate(-3.0, 0.0, 2.0))
   sphere:draw()

   -- grass
   gl.active_texture(3)
   gl.bind_texture('2d', grassAlbedoMap)
   gl.active_texture(4)
   gl.bind_texture('2d', grassNormalMap)
   gl.active_texture(5)
   gl.bind_texture('2d', grassMetallicMap)
   gl.active_texture(6)
   gl.bind_texture('2d', grassRoughnessMap)
   gl.active_texture(7)
   gl.bind_texture('2d', grassAOMap)
   gl.uniform_matrix4f(loc1.model, true, translate(-1.0, 0.0, 2.0))
   sphere:draw()

   -- plastic
   gl.active_texture(3)
   gl.bind_texture('2d', plasticAlbedoMap)
   gl.active_texture(4)
   gl.bind_texture('2d', plasticNormalMap)
   gl.active_texture(5)
   gl.bind_texture('2d', plasticMetallicMap)
   gl.active_texture(6)
   gl.bind_texture('2d', plasticRoughnessMap)
   gl.active_texture(7)
   gl.bind_texture('2d', plasticAOMap)
   gl.uniform_matrix4f(loc1.model, true, translate(1.0, 0.0, 2.0))
   sphere:draw()

   -- wall
   gl.active_texture(3)
   gl.bind_texture('2d', wallAlbedoMap)
   gl.active_texture(4)
   gl.bind_texture('2d', wallNormalMap)
   gl.active_texture(5)
   gl.bind_texture('2d', wallMetallicMap)
   gl.active_texture(6)
   gl.bind_texture('2d', wallRoughnessMap)
   gl.active_texture(7)
   gl.bind_texture('2d', wallAOMap)
   gl.uniform_matrix4f(loc1.model, true, translate(3.0, 0.0, 2.0))
   sphere:draw()
