...
local prog1 = make_program("2.1.2.pbr.vert", "2.1.2.pbr.frag") -- pbrShader
local prog2 = make_program("2.1.2.cubemap.vert", "2.1.2.equirectangular_to_cubemap.frag") -- equirectangularToCubemapShader
local prog3 = make_program("2.1.2.background.vert", "2.1.2.background.frag") -- backgroundShader
local prog4 = make_program("2.1.2.cubemap.vert", "2.1.2.irradiance_convolution.frag") -- irradianceShader
make_program = nil
