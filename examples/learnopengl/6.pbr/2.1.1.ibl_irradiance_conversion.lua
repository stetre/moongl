...
local prog1 = make_program("2.1.1.pbr.vert", "2.1.1.pbr.frag") -- pbrShader
local prog2 = make_program("2.1.1.cubemap.vert", "2.1.1.equirectangular_to_cubemap.frag") -- equirectangularToCubemapShader
local prog3 = make_program("2.1.1.background.vert", "2.1.1.background.frag") -- backgroundShader
make_program = nil

-- get the locations of the uniforms:
local loc1 = {}
local uniforms = { "projection", "view", "model", "camPos",
                  "ao", "albedo", "metallic", "roughness" }
...
gl.uniformi(loc3.environmentMap, 0)
